  ...
  return (
    <>
      <div
        ...
        flex-col items-center jutify-start gap-4 transition-all
         dureation-200 ease-in-out`}
      >
        {/*anchor*/}
        <motion.div
          whileTap={{ scale: 0.9 }}
      ...
      h-full flex flex-col item-start justify-start px-4 md:px-12 py-4 
      md:py-12"
      >
        {/* top section*/}
        <div className="w-full flex items-center justify-between gap-3">
          {/*search */}
          <div
            className="bg-secondary w-full px-4 py-3 rounded-md 
          ...
          >
            ...
            <input
              type="text"
              value={searchTerm}
              className="flex-1 px-4 py-1 text-xl
            ...
            >
              <Link
                ...
                className="bg-emerald-500 px-6 py-2 rounded-md
                 text-white text-lg cursor-pointer hover:bg-emerald-700"
              >
                SignUp
              </Link>
            </motion.div>
